...
class JFormFieldZooItems extends JFormField {

	protected $type = 'ZooItems';
	...
	public function getInput() {
		return $this->render('zooitems', $this->fieldname, $this->value, $this->element, array('control_name' => "jform[{$this->group}]", 'parent' => $this->form->getValue('params'))) ;
	}
